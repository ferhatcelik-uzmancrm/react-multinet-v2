  ...
  sx: {
    ...
    width: {
      ...
      "@media (max-width: 600px)": {
        "--ChartsLegend-itemWidth": "70px", // Adjust for small screens (xs and sm)
      },

      "@media (min-width: 601px) and (max-width: 960px)": {
        "--ChartsLegend-itemWidth": "180px", // Adjust for medium screens (md)
      },
    }
  },
  // width: 900,
    ...
    <Container sx={{
      ...
      <Box>
        <LineChart
          {...lineChartsParams}
          xAxis={[
            { data: years, scaleType: "time", valueFormatter: yearFormater },
          ]}
