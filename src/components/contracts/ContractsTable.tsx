...
export default function ContractsTable() {
  ...
  const handleArchiveClick = (appointmentId: string) => {
    navigate(`/contracts/detail/${appointmentId}`);
  };
  ...
  const filteredRows = rows.filter(
    (row) =>
      ...
      row.subscription.toLowerCase().includes(searchQuery.toLowerCase())
  );
        ...
        >
          <thead>
            <tr>
              ...
              <th style={{ width: 120, padding: 12 }}>Sözleşme No</th>
              <th style={{ width: 180, padding: 12 }}>Lisans No</th>
              <th style={{ width: 160, padding: 12 }}>Tüzel Kişi</th>
              <th style={{ width: 140, padding: 12 }}>Başlangıç Tarihi</th>
              <th style={{ width: 140, padding: 12 }}>Bitiş Tarihi</th>
              <th style={{ width: 120, padding: 12 }}>Sözleşme Tipi</th>
